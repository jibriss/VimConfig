...
let g:pdv_cfg_Author = "Jérôme Brissonnet <jbrissonnet@hi-media.com>"
let g:pdv_cfg_Copyright = "2012 Allopass Hi-media"
...
func! PhpDocFunc()
	...
	while (l:parameters != ",") && (l:parameters != "")
		...
		exe l:txtBOL . g:pdv_cfg_Commentn . "@param $" . l:paramname . " (" . l:paramtype . ") " . g:pdv_cfg_EOL
	endwhile
